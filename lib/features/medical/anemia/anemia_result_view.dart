...
class AnemiaResultView extends StatelessWidget {
  const AnemiaResultView({super.key});
      ...
      body: SafeArea(
        child: BlocConsumer<MedicalCubit, MedicalState>(
          ...
          builder: (context, state) {
            String result = context.read<MedicalCubit>().anemiaResult ?? '';
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          "Result of your anemia analysis",
                        ...
                        Center(
                          child: PrimaryButton(
                            ...
                            text:
                                "you can set alarm for your drugs appointment",
                          ),
                        ),
                        SizedBox(height: 10.h),
                      ],
