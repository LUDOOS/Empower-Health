...
class LiverResultView extends StatelessWidget {
  const LiverResultView({super.key});
      ...
      body: SafeArea(
        child: BlocConsumer<MedicalCubit, MedicalState>(
          ...
          builder: (context, state) {
            String result = context.read<MedicalCubit>().liverResult??'';
